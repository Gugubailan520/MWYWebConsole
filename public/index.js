...
function renderGrid() {
  ...
  grid.innerHTML = pageServers.map(s => {
    ...
    if (t === 'ftp') {
      ...
      cardIcon = svgFolderIcon;
      typeBadge = '<span style="font-size:10px;font-weight:600;color:var(--accent-light);background:rgba(37,99,235,0.12);padding:1px 6px;border-radius:4px;margin-left:6px">SFTP</span>';
